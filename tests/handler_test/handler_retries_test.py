...
def test_handler_with_retries_no_exception():
...
def test_handler_zero_retries_with_exception():
...
def test_handler_exhausts_retries():
...
def test_handler_with_successful_retry_after_multiple_failures():
...
def test_handler_with_negative_retries():
